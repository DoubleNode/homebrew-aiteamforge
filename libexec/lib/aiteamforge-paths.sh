...
_AITEAMFORGE_DEFAULT_TEAMS_DATA() {
    ...
    printf '%s\t%s\t%s\t%s\t%s\t%s\t%s\n' "freelance-doublenode-starwords"    "${_shared_prefix}/DoubleNode/Starwords/kanban"     "${_shared_prefix}/DoubleNode/Starwords"     "8504"  "8500" "100" "FSW"
    printf '%s\t%s\t%s\t%s\t%s\t%s\t%s\n' "freelance-doublenode-appplanning"  "${_shared_prefix}/DoubleNode/appPlanning/kanban"  "${_shared_prefix}/DoubleNode/appPlanning"  "8500"  "8500" "100" "FAP" # xaca-0139:allowed — justified survivor (backward-compat default, overridden by org resolver)
    printf '%s\t%s\t%s\t%s\t%s\t%s\t%s\n' "freelance-doublenode-workstats"    "${_shared_prefix}/DoubleNode/WorkStats/kanban"    "${_shared_prefix}/DoubleNode/WorkStats"    "8506"  "8500" "100" "FWS" # xaca-0139:allowed — justified survivor (backward-compat default, overridden by org resolver)
    printf '%s\t%s\t%s\t%s\t%s\t%s\t%s\n' "freelance-doublenode-lifeboard"    "${_shared_prefix}/DoubleNode/LifeBoard/kanban"    "${_shared_prefix}/DoubleNode/LifeBoard"    "8503"  "8500" "100" "FLB" # xaca-0139:allowed — justified survivor (backward-compat default, overridden by org resolver)
    printf '%s\t%s\t%s\t%s\t%s\t%s\t%s\n' "freelance-doublenode-caravan"      "${_shared_prefix}/DoubleNode/Caravan/kanban"      "${_shared_prefix}/DoubleNode/Caravan"      "8502"  "8500" "100" "VAN" # xaca-0139:allowed — justified survivor (backward-compat default, overridden by org resolver)
    printf '%s\t%s\t%s\t%s\t%s\t%s\t%s\n' "freelance-doublenode-awaysentry"   "${_shared_prefix}/DoubleNode/AwaySentry/kanban"   "${_shared_prefix}/DoubleNode/AwaySentry"   "8501"  "8500" "100" "FAS" # xaca-0139:allowed — justified survivor (backward-compat default, overridden by org resolver)
