...
- XACA-0625: LCARS Roadmap tab — aggregate Epics & Releases into an exportable timeline view with print/PDF export (`share/lcars-ui/js/lcars.js`, `share/lcars-ui/css/lcars.css`, `share/lcars-ui/index.html`, `share/lcars-ui/server.py`; cache-busters bumped `lcars.js?v=3.23`→`?v=3.24`, `lcars.css?v=32.0`→`?v=32.1`). Mirror of canonical lcars-ui changes via `sync-tap.sh`.
