...
SESSION_THEME="${1:-Legal Session Theme}"
SESSION_TYPE="${2:-Legal Session Type}"
SESSION_NAME="${3:-Legal Session Name}"
TERMINAL_NUMBER="${4:-Legal Terminal Number}"
TERMINAL_NAME="${5:-Legal Terminal Name}"
SESSION_DESCRIPTION="${6:-Legal Terminal Name}"
SESSION_LOCATION="${7:-LEGAL SESSION_LOCATION}"
...
# Command Blue (Legal Authority) - for legal-chambers
COMMAND_BLUE='%F{25}'              # Deep blue
COMMAND_BLUE_BRIGHT='%F{33}'       # Brighter blue for highlights

# Operations Gold (Administrative Work) - for legal-discovery, legal-filings, legal-timeline
OPS_GOLD='%F{178}'                # Mustard gold
OPS_GOLD_DARK='%F{136}'           # Darker gold for contrast

# Sciences Blue (Research & Diplomacy) - for legal-research, legal-mediation
...
display_agent_avatar "legal" "$SESSION_DEVELOPER"
