/**
 * LCARS DoubleNode Dashboard Application
 * Filtered view showing DoubleNode divisions
 *
 * Divisions: dns, freelance-doublenode-workstats, freelance-doublenode-starwords
 */
...
(function() {
    ...
    const CONFIG = {
        ...
        divisions: ['dns', 'freelance-doublenode-workstats', 'freelance-doublenode-starwords', 'freelance-doublenode-appplanning'],
        dashboardName: 'DOUBLENODE',
        emptyMessage: 'No active DoubleNode divisions detected'
    };
    ...
    document.addEventListener('DOMContentLoaded', function() {
        console.log('[LCARS] DoubleNode Dashboard initializing...');
        ...
        console.log('[LCARS] DoubleNode Dashboard initialized');
    });
    ...
    function createTeamCard(name, data) {
        ...
        var avatarHtml = '';
        if (avatarUrl) {
            var divisionClass = session.division ? 'div-' + session.division.toLowerCase() : 'div-doublenode';
